params = {
    ...
    'dataset_path': 'data/modified_interpolated_controlled_path_data_1000_updated_aoa.pkl',  # combined_fspl_log_distance.csv',  # combined_urban_area.csv # linear_path_static_new_1to10k_updated_aoa.pkl
