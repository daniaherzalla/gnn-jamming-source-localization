params = {
    ...
    'additional_features': ['mean_noise', 'std_noise', 'range_noise', 'dist_to_centroid', 'sin_azimuth', 'cos_azimuth', 'moving_avg_aoa'],  # ['sin_azimuth', 'cos_azimuth', 'relative_noise', 'proximity_count', 'std_noise', 'range_noise'],
    'num_neighbors': 50,
    'edges': 'knn',  # opts: 'knn', 'proximity'
    'norm': 'minmax',  # opts: 'minmax', 'unit_sphere'
    'activation': False,
    'max_nodes': 60,
    'experiments_folder': 'dynamic/controlled/',
    'dataset_path': 'data/guided_path_data.csv',  # combined_fspl_log_distance.csv',  # combined_urban_area.csv
    'test_sets': ['raw_test_data.csv'],
    'dynamic': True,
